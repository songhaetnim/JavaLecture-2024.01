...
public class GH {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(strong.text());       // 하나짜리 가져오는거
...
//			System.out.println(addr.strip());
		...
		// 한글 주소는 인코딩되어서 보임 -> =%EC%88%98%EC%9B%90 <- 수원이란 소리
...
//		doc = Jsoup.connect(url).get();
		...
		// 여러개의 엘리먼트
		Elements lis = doc.select(".dp_li.num-1");   // 클래스 이름마다 점을 찍어줄것 . . .
