...
#경기도 광주시 추가 - auto_increment 속성이 설정되어 있어도  ID 값을 임의로 부여 가능
 INSERT INTO kcity VALUES(2600,'광주','kyonggi',300000);
...
#강원도 속초시 삭제
  ...
  DELETE FROM kcity WHERE id =2600;
